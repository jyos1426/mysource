...
/**
 * Created by Hyeon on 2016-06-08.
 */
public class DeleteMessage {
    private FinishCallBack callBack;

    public void execute(int msgNum){

        new connectToServer().execute(msgNum);
    }

    private class connectToServer extends AsyncTask<Integer,Void,String> {
        private String urlString = "http://poom.dothome.co.kr/message/delMessage.php";
        private String data;
