...
function getLoadLog(req, cb) {
    ...
    var _req = http.request(options, (_res) => {
        ...
        _res.on('end', () => {
			...
			console.log('\n\n********************************************************');
			console.log('  QUERY START | get LoadLog');
			console.log('--------------------------------------------------------');
			console.log(options);
			console.log('--------------------------------------------------------');
			console.log('path =>' + options.path);      
			console.log('--------------------------------------------------------');
			console.log('  QUERY END | get LoadLog');
            console.log('********************************************************\n'); 
...
// 부하 테스트 상세 로그를 가져온다.
function getLoadLogDetail(req, cb) {
    ...
    var _req = http.request(options, (_res) => {
        ...
        _res.on('end', () => {
			...
			console.log('\n\n********************************************************');
			console.log('  QUERY START | get LoadLog Detail');
			console.log('--------------------------------------------------------');
			console.log(options);
			console.log('--------------------------------------------------------');
			console.log('path =>' + options.path);      
			console.log('--------------------------------------------------------');
			console.log('  QUERY END | get LoadLog Detail');
            console.log('********************************************************\n'); 
...
module.exports = {
    ...
    getLoadLogDetail: getLoadLogDetail
};
